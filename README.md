...
[![GitHub Tests Action Status](https://img.shields.io/github/workflow/status/ismareno/laravel-example/run-tests?label=tests)](https://github.com/ismareno/laravel-example/actions?query=workflow%3Arun-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://img.shields.io/github/workflow/status/ismareno/laravel-example/Check%20&%20fix%20styling?label=code%20style)](https://github.com/ismareno/laravel-example/actions?query=workflow%3A"Check+%26+fix+styling"+branch%3Amain)
...
```php
$laravel-example = new Ismareno\Example();
echo $laravel-example->echoPhrase('Hello, Ismareno!');
```
